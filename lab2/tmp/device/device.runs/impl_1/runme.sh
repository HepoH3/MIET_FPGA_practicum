...
HD_PWD='D:/Verilog/lb_2/tmp/device/device.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_dev.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_dev.tcl -notrace
