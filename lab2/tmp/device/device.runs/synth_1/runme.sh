...
HD_PWD='D:/Verilog/lb_2/tmp/device/device.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_dev.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_dev.tcl
